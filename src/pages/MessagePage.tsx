  ...
  return (
    <div>
      ...
      <div className="p-6 space-y-6">
        <h3 className="text-5xl font-bold">Receba as boas-vindas à sua caixa de entrada!</h3>
        <p className=" text-xl text-gray-500">Escreva, compartilhe posts e muito mais com conversas privadas entre voce e outras pessoas no X.</p>
