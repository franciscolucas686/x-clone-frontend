...
export default function MessageModal({ onClose }: MessageModalProps) {
  ...
  return (
    <ModalLayout
      onClose={onClose}
      className="max-w-[600px] h-[80vh] max-h-[700px]"
    >
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between border-b border-gray-200 pb-3">
          <h3 className="text-lg font-semibold text-gray-800 ml-10 cursor-default">
            Nova mensagem
          </h3>
          <button
            type="button"
        ...
        <div className="border-t border-gray-200 pt-3">
          <div className="hover:bg-blue-100 transition px-4 py-2 rounded-full cursor-pointer">
            <Users
              size={20}
              className="inline-block mr-2 text-blue-500 cursor-pointer"
            />
